      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-md border-b border-slate-200">
        <nav className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-3">
            ...
            <span className="text-lg font-black tracking-tighter uppercase">PORTFOLIO_v2.0</span>
          </Link>
            ...
            {navLinks.map((link) => (
              <a
                ...
                className={cn(
                  ...
                  pathname === link.path && !link.path.startsWith('#')
                    ? 'text-primary'
                    : 'text-slate-600'
                )}
              >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-12 mb-16">
            <div className="flex flex-col gap-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-black tracking-tighter uppercase">PORTFOLIO_v2.0</span>
              </div>
